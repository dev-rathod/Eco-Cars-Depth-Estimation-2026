...
PRED_DIR   = os.path.expanduser('~/video_depth/small/depths/all_depths')
GT_DIR     = os.path.expanduser('~/groundtruth/depth')
OUT_CSV    = os.path.expanduser('~/rmse_results_small.csv')
SEED       = 42
SEEN_RATIO = 0.30
...
# ── Step 1: Pool all seen pixels for calibration ─────────────────────────
...
# ── Step 2: Clean and fit power calibration curve ────────────────────────
...
# ── Step 3: Compute RMSE on unseen segments ──────────────────────────────
