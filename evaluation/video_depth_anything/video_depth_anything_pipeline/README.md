...
pip install -r evaluation/video_depth_anything/video_depth_anything_pipeline/requirements.txt
```
...
```bash
python evaluation/video_depth_anything/video_depth_anything_pipeline/extract_frames.py \
...
```bash
python evaluation/video_depth_anything/video_depth_anything_pipeline/infer_frames.py \
...
```bash
python evaluation/video_depth_anything/video_depth_anything_pipeline/eval_video_depth_anything.py \
